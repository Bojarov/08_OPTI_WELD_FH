...
def main():
    ...
    thick=Ro-Ri
    rdi_v = [Ri]
    #rdo_v = [Ro]#, Ro-0.2*thick, Ro-0.4*thick, Ro-0.6*thick, Ro-0.8*thick]
    #rdo_v = [Ro-0.2*thick]#, Ro-0.4*thick, Ro-0.6*thick, Ro-0.8*thick]
    #rdo_v = [Ro-0.4*thick]#, Ro-0.6*thick, Ro-0.8*thick]
    #rdo_v = [Ro-0.6*thick]#, Ro-0.8*thick]
    #rdo_v = [Ro-0.8*thick]
    rdo_v = [Ri]
    ...
    op.b_at_det_plot_f4( phi_cv, dw_v, rdi_v, rdo_v, lw_v, xd_v, yd_v, zd_v, f_v,
        params, damage_params, output_params, filament_params, node_dens_vec, r_sub_vec)

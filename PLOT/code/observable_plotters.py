...
#####################################################################
        ...
        ax.plot(xd_v, (np.array(b_vec)-np.array(b_vec_0))/(np.array(b_vec_0)), marker='o',markersize=2, label=r'$d_d=$' + str(i) + r'm')
        ...
        plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$f=$'+str(freq)+r'$Hz$'+r', $l_d=$'+str(l_weld)+r'$m$')
...
#####################################################################
        ...
        #    b_vec_0 = b_vec
        ax.ticklabel_format(axis='y', style='sci', scilimits=(0,0), useOffset=None, useLocale=None, useMathText=None)
        ax.plot(xd_v, (np.array(b_vec)-np.array(b_vec_0))/(np.array(b_vec_0)), marker='o',markersize=2, label=r'$f=$' + str(i) + r'Hz')
        ax.set_xlabel(r'$x[m]$', fontsize = 20)
        ax.set_ylabel(r'$(\tilde{B}_f-\tilde{B}_0)/\tilde{B}_0$', fontsize = 20)
        ax.legend(loc='upper right', fontsize=10)
        plt.subplots_adjust(left=0.15, bottom=0.15, right=0.95, top=None, wspace=None, hspace=None)
        plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$d_d=$'+str(d_weld)+r'$m$'+r', $l_d=$'+str(l_weld)+r'$m$')
        plt.grid(linewidth=0.5)
        #fig.savefig("2_2_2.pdf", dpi=gcf().dpi)
        #plt.savefig('plot.pdf', dpi=fig.dpi, bbox_inches='tight')
    #plt.tight_layout()
...
#####################################################################
        ...
        ax.ticklabel_format(axis='y', style='sci', scilimits=(0,0), useOffset=None, useLocale=None, useMathText=None)
        ax.plot(xd_v, (np.array(b_vec)-np.array(b_vec_0))/(np.array(b_vec_0)), marker='o',markersize=2, label=r'$R_o-r_{d_o}/d=$' +"%.2f" % round((ro_t-i)/(ro_t-ri_t),2))
        ax.set_xlabel(r'$x[m]$', fontsize = 20)
        ax.set_ylabel(r'$(\tilde{B}_f-\tilde{B}_0)/\tilde{B}_0$', fontsize = 20)
        ax.legend(loc='upper right', fontsize=10)
        plt.subplots_adjust(left=0.15, bottom=0.15, right=0.95, top=None, wspace=None, hspace=None)
        plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$f=$'+str(freq)+r'$Hz$'+r', $d_d=$'+str(d_weld)+r'$m$'+r', $l_d=$'+str(l_weld)+r'$m$')
        plt.grid(linewidth=0.5)
        #fig.savefig("2_2_2.pdf", dpi=gcf().dpi)
        #plt.savefig('plot.pdf', dpi=fig.dpi, bbox_inches='tight')
    #plt.tight_layout()
...
#####################################################################
        ...
        plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$R_o-r_{d_o}/d=$' +"%.2f" % round((ro_t-rd_o)/(ro_t-ri_t),2)+r', $d_d=$'+str(d_weld)+r'$m$')
        plt.grid(linewidth=0.5)
        #fig.savefig("2_2_2.pdf", dpi=gcf().dpi)
        #plt.savefig('plot.pdf', dpi=fig.dpi, bbox_inches='tight')
    #plt.tight_layout()
...
#####################################################################
        ...
        ax.ticklabel_format(axis='y', style='sci', scilimits=(0,0), useOffset=None, useLocale=None, useMathText=None)
        ax.plot(xd_v, (np.array(b_vec)-np.array(b_vec_0))/(np.array(b_vec_0)), marker='o',markersize=2, label=r'$(r_{d_i}-R_i)/d=$' +"%.2f" % round((i-ri_t)/(ro_t-ri_t),2))
        ax.set_xlabel(r'$x[m]$', fontsize = 20)
        ax.set_ylabel(r'$(\tilde{B}_f-\tilde{B}_0)/\tilde{B}_0$', fontsize = 20)
        ax.legend(loc='upper right', fontsize=10)
        plt.subplots_adjust(left=0.15, bottom=0.15, right=0.95, top=None, wspace=None, hspace=None)
        ...
        #plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$r_{d_i}-R_i/d=$' +"%.2f" % round((rd_i-Ri)/(ro_t-ri_t),2)+r', $d_d=$'+str(d_weld)+r'$m$')
        plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$f=$'+str(freq)+r'$Hz$'+r', $d_d=$'+str(d_weld)+r'$m$')
...
#####################################################################
        ...
        #plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$d_d=$'+str(d_weld)+r'$m$'+r', $l_d=$'+str(l_weld)+r'$m$')
        print(rd_i)
        plt.title(r'$\varphi_d=$'+str(phi_c_weld/np.pi)+r'$\pi$, '+r'$r_{d_i}-R_i/d=$' +"%.2f" % round((rd_i-ri_t)/(ro_t-ri_t),2)+r', $d_d=$'+str(d_weld)+r'$m$')
...
#####################################################################
        ...
        ax.ticklabel_format(axis='y', style='sci', scilimits=(0,0), useOffset=None, useLocale=None, useMathText=None)
        ax.plot(xd_v, (np.array(b_vec)-np.array(b_vec_0))/(np.array(b_vec_0)), marker='o',markersize=2, label=r'$l_d=$'+str(i)+r'$m$')
        ax.set_xlabel(r'$x[m]$', fontsize = 20)
        ax.set_ylabel(r'$(\tilde{B}_f-\tilde{B}_0)/\tilde{B}_0$', fontsize = 20)
        ax.legend(loc='upper right', fontsize=10)
        plt.subplots_adjust(left=0.15, bottom=0.15, right=0.95, top=None, wspace=None, hspace=None)
